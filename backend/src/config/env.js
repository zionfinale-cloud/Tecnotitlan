...
export const config = {
  ...
  API_PUBLIC_URL: process.env.API_PUBLIC_URL || 'https://api.tecnotitlan.com.mx',
  WHATSAPP_PROVIDER: process.env.WHATSAPP_PROVIDER || 'baileys',
  WHATSAPP_AUTH_STORAGE: process.env.WHATSAPP_AUTH_STORAGE || 'database',
  WHATSAPP_AUTO_CONNECT: process.env.WHATSAPP_AUTO_CONNECT ?? 'true',
