...
const SENSITIVE_SETTING_DEFINITIONS = [
    ...
    { key: 'WHATSAPP_MAX_RECONNECT_ATTEMPTS', label: 'WhatsApp maximo de reintentos automaticos', type: 'string' },
    { key: 'WHATSAPP_RECONNECT_BASE_DELAY_MS', label: 'WhatsApp espera inicial entre reintentos (ms)', type: 'string' },
    { key: 'WHATSAPP_RECONNECT_MAX_DELAY_MS', label: 'WhatsApp espera maxima entre reintentos (ms)', type: 'string' },
