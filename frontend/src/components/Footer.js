      ...
      <Container>
        <Row className="mb-5">
          <Col md={4} className="mb-4 mb-md-0">
            <h2 className={styles.footerTitle}>{siteName}</h2>
          ...
          <Col xs={6} md={2} className="mb-4 mb-md-0">
            <h2 className={styles.footerTitle}>Navegación</h2>
          ...
          <Col xs={6} md={3} className="mb-4 mb-md-0">
            <h2 className={styles.footerTitle}>Ayuda</h2>
          ...
          <Col md={3}><h2 className={styles.footerTitle}>Pagos seguros</h2><div className={styles.paymentIcons} role="img" aria-label="PayPal, Mastercard, Visa y American Express"><i className="fab fa-cc-paypal"></i><i className="fab fa-cc-mastercard"></i><i className="fab fa-cc-visa"></i><i className="fab fa-cc-amex"></i></div></Col>
        </Row>
