...
const UnifiedInboxScreen = () => {
  ...
  const load = async ({ silent = false } = {}) => {
    ...
    try {
      const { data } = await api.get('/unified-inbox');
